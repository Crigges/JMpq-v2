...
public class MpqCrypto {
	...
	public final static int MPQ_KEY_HASH_TABLE =          0xC3AF3770;  // Obtained by HashString("(hash table)", MPQ_HASH_FILE_KEY)
	public final static int MPQ_KEY_BLOCK_TABLE =         0xEC83B3A3;  // Obtained by HashString("(block table)", MPQ_HASH_FILE_KEY)
